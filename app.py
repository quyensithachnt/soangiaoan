...
<div class="main-header">
    ...
    <p>Tác giả: Quyền Sĩ Thạch - Trường PTDTBT Tiểu học Nghĩa Thuận - ĐT: 0984569555</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Quyền Sĩ Thạch - Trường PTDTBT Tiểu học Nghĩa Thuận - ĐT: 0984569555</div>", unsafe_allow_html=True)
